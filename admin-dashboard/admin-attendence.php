   ...
   <!-- main content area start --> 
    <div class="container">
      <div class="row mt-5">
        ...
        <div class="col-6" style="margin-top: 118px;">
            ...
            <input type="submit" class="btn btn-block" name="btn_sub" value="Go">
          </form>
      </div>
            <table class='table table-sm table-striped table-hover' style="margin-top: 100px;">
              <thead>
                <tr><th scope='col'>S.no</th>
                  <th scope='col'>Student Name</th>
                  <th scope='col'>mark_date</th>
